<?php
namespace Ingenieria\EstudianteBundle\Form\Type;
...
class BitacoraType extends AbstractType
{
    ...
    {
        $builder
		->add('nombreActividad','text', array('label' => 'Nombre actividad:' , 'required' => true))
		->add('descripcion','textarea', array('label' => 'Descripción:' , 'required' => true , 'attr' => array('cols' => '60', 'rows' => '7', 'placeholder' => '¡Máximo 1200 carácteres!' )))
